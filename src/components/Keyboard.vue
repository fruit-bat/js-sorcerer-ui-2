...
<template>
  <equipment>
    ...
    <v-layout row>
      <v-layout row class="exidy-key-row">
        <Key key-id="GRAPHIC" @pressed="keypress" :keystate="keystate" :width="2" dark toggle>
          <div slot="content" style="padding-top:10px;font-size:11px;line-height:11px;">
            GRAPHIC
          </div>
        </key>
        ...
        <Key key-id="Unknown2" @pressed="keypress" :keystate="keystate" dark toggle>
    ...
    <v-layout row style="margin-left:16px">
      <v-layout row class="exidy-key-row">
        ...
        <Key key-id="SHIFT" @pressed="keypress" :keystate="keystate" :width="2" toggle>
          <div slot="content" style="padding-top:10px;font-size:11px;line-height:11px;">
            SHIFT
          </div>
        </key>
    ...
    <v-layout row style="margin-left:48px">
      <v-layout row class="exidy-key-row">
